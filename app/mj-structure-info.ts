...
const muscleZh:Record<string,string>={
 ...
 'external anal sphincter':'肛門外括約肌','external intercostal muscle':'肋間外肌','internal intercostal muscle':'肋間內肌','innermost intercostal muscle':'肋間最內肌','flexor digiti minimi brevis of foot':'足小趾短屈肌','opponens digiti minimi of foot':'足小趾對蹠肌','lateral lumbar intertransversarius':'腰外側橫突間肌','medial lumbar intertransversarius':'腰內側橫突間肌','cervical rotator':'頸迴旋肌','thoracic rotator':'胸迴旋肌','lumbar rotator':'腰迴旋肌','iliococcygeus':'髂尾肌','lateral crico-arytenoid':'環杓外側肌','posterior crico-arytenoid':'環杓後肌','cricothyroid':'環甲肌','transverse arytenoid':'杓橫肌','uvular muscle':'懸雍垂肌','longus colli':'頸長肌','superficial perineal muscle':'淺會陰肌','papillary muscle of ventricle':'心室乳頭肌','anterior papillary muscle of ventricle':'心室前乳頭肌','posterior papillary muscle of ventricle':'心室後乳頭肌','septal papillary muscle of ventricle':'心室隔側乳頭肌','lateral papillary muscle of ventricle':'心室外側乳頭肌','abductor digiti minimi of foot':'足小趾外展肌','biceps femoris':'股二頭肌','flexor hallucis brevis':'拇短屈肌','adductor hallucis':'拇收肌','inferior oblique part of longus colli':'頸長肌下斜部','superior oblique part of longus colli':'頸長肌上斜部','vertical intermediate part of longus colli':'頸長肌垂直中間部','oblique part of cricothyroid':'環甲肌斜部','straight part of cricothyroid':'環甲肌直部','orbicularis oris':'口輪匝肌','frontalis':'額肌','occipitalis':'枕肌','orbicularis oculi':'眼輪匝肌','orbital part of orbicularis oculi':'眼輪匝肌眶部','palpebral part of orbicularis oculi':'眼輪匝肌瞼部','corrugator supercilii':'皺眉肌','levator labii superioris alaeque nasi':'提上唇鼻翼肌','levator labii superioris':'提上唇肌','zygomaticus major':'顴大肌','zygomaticus minor':'顴小肌','depressor labii inferioris':'降下唇肌','levator anguli oris':'提口角肌','mentalis':'頦肌','depressor anguli oris':'降口角肌','buccinator':'頰肌','risorius':'笑肌','masseter':'咬肌','superficial part of masseter':'咬肌淺部','deep part of masseter':'咬肌深部','temporalis':'顳肌','medial pterygoid':'內翼肌','lateral pterygoid':'外翼肌','upper head of lateral pterygoid':'外翼肌上頭','lower head of lateral pterygoid':'外翼肌下頭','nasalis':'鼻肌','procerus':'降眉間肌'
};

const exactZh:Record<string,string>={
 'clavicle':'鎖骨','scapula':'肩胛骨','humerus':'肱骨','radius':'橈骨','ulna':'尺骨','femur':'股骨','tibia':'脛骨','fibula':'腓骨','patella':'髕骨','hyoid bone':'舌骨','hip bone':'髖骨','clavicular part of pectoralis major':'胸大肌鎖骨頭','sternocostal part of pectoralis major':'胸大肌胸肋頭','abdominal part of pectoralis major':'胸大肌腹部','sternum':'胸骨','body of sternum':'胸骨體','manubrium':'胸骨柄','xiphoid process':'劍突','atlas':'寰椎','axis':'樞椎','sacrum':'薦骨','coccyx':'尾骨','ethmoid':'篩骨','frontal bone':'額骨','occipital bone':'枕骨','sphenoid bone':'蝶骨','vomer':'犁骨','mandible':'下頜骨','maxilla':'上頜骨','nasal bone':'鼻骨','palatine bone':'顎骨','parietal bone':'頂骨','temporal bone':'顳骨','zygomatic bone':'顴骨','calcaneus':'跟骨','talus':'距骨','cuboid bone':'骰骨','navicular bone of foot':'足舟骨','medial cuneiform bone':'內側楔骨','intermediate cuneiform bone':'中間楔骨','lateral cuneiform bone':'外側楔骨','sesamoid bone of foot':'足籽骨','triquetral':'三角骨','gingiva of upper jaw':'上顎牙齦','gingiva of lower jaw':'下顎牙齦',
...
function chineseName(name:string,system:SystemId){
 ...
 const head=/^(long|short|medial|lateral|humeral|ulnar|oblique|transverse|superficial|deep|anterolateral)\s+head\s+of\s+(.+)$/i.exec(base);
 if(head){const b=directBaseChinese(head[2]);const h:{[k:string]:string}={long:'長頭',short:'短頭',medial:'內側頭',lateral:'外側頭',humeral:'肱骨頭',ulnar:'尺骨頭',oblique:'斜頭',transverse:'橫頭',superficial:'淺頭',deep:'深頭',anterolateral:'前外側頭'};if(b)return side+b+h[head[1].toLowerCase()];}
