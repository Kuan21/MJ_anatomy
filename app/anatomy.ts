...
export interface SceneState {tissueMotion?:boolean;inspectorOpen?:boolean;explode:number;visible:SystemId[];selected:string[];hiddenParts?:string[];depthFilter?:'all'|'superficial'|'intermediate'|'deep';focusParts?:string[];cameraFocusParts?:string[];cameraFocusNonce?:number;partTransforms?:Record<string,PartTransform>;isolate:boolean;view:View;rotate:boolean;reset:number}
