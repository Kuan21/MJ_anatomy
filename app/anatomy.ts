...
export interface SceneState {inspectorOpen?:boolean;explode:number;visible:SystemId[];selected:string[];focusParts?:string[];isolate:boolean;view:View;rotate:boolean;reset:number}
