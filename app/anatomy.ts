...
export const SYSTEMS: {id:SystemId;name:string;color:string;description:string}[] = [
 ...
 {id:'arterial',name:'Arteries',color:'#8f2633',description:'The heart drives blood through the circulation. Arteries carry blood away from the heart to supply tissues or, in the pulmonary circuit, to the lungs.'},
 ...
 {id:'nervous',name:'Nervous system',color:'#e2bd4a',description:'The brain, spinal cord, and peripheral nerves carry and process signals. They support sensation, movement, coordination, and automatic regulation of body functions.'},
...
export interface SceneState {jointSurfaces?:boolean;muscleLayer?:import('./mj-muscle-layers').UpperLimbMuscleLayer;faceMuscleLayer?:import('./mj-facial-layers').FacialMuscleLayer;bodyMotion?:{region:import('./biomechanics-v2/body-motion').BodyRegion;pose:import('./biomechanics-v2/body-motion').BodyPose};tissueMotion?:boolean;inspectorOpen?:boolean;explode:number;visible:SystemId[];selected:string[];hiddenParts?:string[];depthFilter?:'all'|'superficial'|'intermediate'|'deep';focusParts?:string[];cameraFocusParts?:string[];cameraFocusNonce?:number;cameraFocusScale?:number;partTransforms?:Record<string,PartTransform>;isolate:boolean;view:View;rotate:boolean;reset:number}
