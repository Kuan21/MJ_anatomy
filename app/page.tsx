...
export default function Home(){
 ...
 const profileForConcept=(c:Concept)=>{const p=c.elements.map(id=>parts.get(id)).find(Boolean);return p?structureProfile(c.name,p.system):undefined;};
 const profileForPart=(id:string)=>{const p=parts.get(id);return p?structureProfile(p.name,p.system):undefined;};
