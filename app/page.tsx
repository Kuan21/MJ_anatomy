...
export default function Home(){
 ...
 return <main className="studio">
  ...
  <aside className="right-workspace" aria-label="模型檢視與關節動作">
   ...
   <details className="joint-workspace glass"><summary><span>關節系統與動作</span><label className="motion-enable-toggle" onClick={e=>e.stopPropagation()}><input type="checkbox" checked={motionEnabled} onChange={e=>setMotionEnabled(e.target.checked)}/><span>{motionEnabled?'已啟用':'啟用活動'}</span></label></summary><div className="joint-workspace-content">
