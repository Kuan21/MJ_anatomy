...
for(const side of ['left','right']){
 ...
 console.log(`${side}: ${skin.length} tissues; 7 poses finite; exact neutral; pinned endpoints; shared deltoid seams; split-tube continuity PASS`);
}
